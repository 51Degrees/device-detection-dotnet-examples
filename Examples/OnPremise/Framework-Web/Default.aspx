    ...
    <div class="c-eg-page">
        ...
        <% if (engine.DataSourceTier == "Lite") { %>
            <div class="c-eg-message">
              <p class="c-eg-message__text">The paid data file adds daily automatic updates, non-human identification and IP intelligence. <a href="https://51degrees.com/contact-us?utm_source=code&amp;utm_medium=example&amp;utm_campaign=device-detection-dotnet-examples&amp;utm_content=examples-onpremise-framework-web-default.aspx&amp;utm_term=paid-data-file">Contact us</a> to explore the options.</p>
              <a class="b-btn c-eg-message__cta" href="https://51degrees.com/contact-us?utm_source=code&amp;utm_medium=example&amp;utm_campaign=device-detection-dotnet-examples&amp;utm_content=examples-onpremise-framework-web-default.aspx&amp;utm_term=paid-data-file">Contact us</a>
            </div>
        <% } %>
    </div>
