...
<body>
    <div class="c-eg-page">
        ...
        <div id="content">
            ...
            <table class="c-eg-table">
                ...
                <%
                    ...
                    {
                %>
                <tr class="c-eg-table__row c-eg-table__row--present"><td class="c-eg-table__cell c-eg-table__cell--key">Get IDeviceData Error:</td><td class="c-eg-table__cell"> <%: ex %></td></tr>
                <%
                    }
        ...
        <div class="c-eg-message">
          <p class="c-eg-message__text">Want to try on-premise? <a href="https://51degrees.com/contact-us?utm_source=code&amp;utm_medium=example&amp;utm_campaign=device-detection-dotnet-examples&amp;utm_content=examples-cloud-framework-web-default.aspx&amp;utm_term=try-on-premise">Contact us</a> to discuss requirements.</p>
          <a class="b-btn c-eg-message__cta" href="https://51degrees.com/contact-us?utm_source=code&amp;utm_medium=example&amp;utm_campaign=device-detection-dotnet-examples&amp;utm_content=examples-cloud-framework-web-default.aspx&amp;utm_term=try-on-premise">Contact us</a>
        </div>
    </div>
