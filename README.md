...
| pmp-web                       | Pages carrying the 51Degrees Preference Management Platform and the client script in every arrangement the shared browser tests check, built as plain files so every language can serve the same pages. See its README.     |
